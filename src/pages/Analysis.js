              ...
              <div className="flex items-start space-x-8">
                <div className="flex-1 min-w-0">
                  ...
                  <Link to={`/article/${article.id}`}>
                    <h2 className="text-2xl font-serif font-bold text-gray-900 dark:text-white mb-3 hover:text-blue-900 dark:hover:text-blue-400 transition-colors">
        ...
        <div className="flex justify-center mt-8 space-x-2">
          {Array.from({ length: totalPages }, (_, i) => i + 1).map(page => (
            <button
              ...
              className={`px-4 py-2 rounded-lg font-medium transition-colors border border-blue-700 dark:border-blue-800 focus:outline-none focus:ring-2 focus:ring-blue-500 dark:focus:ring-blue-400
                ${currentPage === page
                  ? 'bg-blue-700 text-white dark:bg-blue-800'
                  : 'text-blue-700 bg-white hover:bg-blue-50 dark:text-blue-300 dark:bg-gray-900 dark:hover:bg-blue-900'}
              `}
            >
              {page}
            </button>
