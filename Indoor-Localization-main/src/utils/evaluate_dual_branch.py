"""
Evaluation Script for Dual Branch Indoor Localization Model
========================================================

This script evaluates the trained dual branch model and generates visualizations
to analyze its performance, including:
...
def load_data(data_dir: str):
    ...
    Returns:
        Tuple of (X_csi_test, X_rssi_test, y_test)
    """
...
def evaluate_model(model_path: str, test_data: tuple, save_dir: str):
    ...
    # Load model
    model = DualBranchModel.load(model_path)
...
def main():
    ...
    model_path = Path('Indoor-Localization-main/models/dual_branch/best_model.keras')
    save_dir = Path('Indoor-Localization-main/models/dual_branch/evaluation')
