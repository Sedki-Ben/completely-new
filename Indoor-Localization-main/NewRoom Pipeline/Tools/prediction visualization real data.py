...
if __name__ == "__main__":
    ...
    # Save the figure
    fig.savefig(os.path.join(results_dir, 'random_samples_visualization.png'), dpi=300, bbox_inches='tight')
    print(f"Visualization saved to {os.path.join(results_dir, 'random_samples_visualization.png')}")
    ...
    fig2 = visualize_random_samples(y_test, y_pred, num_samples=20, grid_size=room_dimensions, 
                                  step_size=0.5, room_name="Test Environment")
    fig2.savefig(os.path.join(results_dir, 'random_20_samples_visualization.png'), dpi=300, bbox_inches='tight')