...
plots_dir = r"C:\MasterArbeit\NewRoom Pipeline\Plots"
...
# Save CDF plot
cdf_plot_path = os.path.join(plots_dir, 'error_cdf.png')
...
# Save scatter plot
scatter_plot_path = os.path.join(plots_dir, 'actual_vs_predicted_positions.png')
...
print(f"Error metrics saved to {os.path.join(results_dir, 'error_metrics.txt')}")
