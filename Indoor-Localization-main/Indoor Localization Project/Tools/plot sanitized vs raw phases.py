...
# File path
file_path = r"C:\MasterArbeit\NewRoom Pipeline\Data\Amp+Phase_Data\sub 50 to 70\updated\sanitized051index phases\sanitized051_Amp+Phase_1.0,1.5 processednew.csv"
# Read the CSV file
...
# Save the plot
save_dir = r"C:\MasterArbeit\NewRoom Pipeline\Plots"
os.makedirs(save_dir, exist_ok=True)  # Create the directory if it doesn't exist
save_path = os.path.join(save_dir, "sanatised_vis2.png")
